const LABEL_COLORS = {
  ...
  'Date':                     { bg: 'bg-teal-100',   text: 'text-teal-800',   border: 'border-teal-300' },
  'Device':                   { bg: 'bg-yellow-100', text: 'text-yellow-800', border: 'border-yellow-300' },
  'Disease':                  { bg: 'bg-red-100',    text: 'text-red-900',    border: 'border-red-400' },
  ...
  'Measuring Device':         { bg: 'bg-amber-100',  text: 'text-amber-800',  border: 'border-amber-300' },
  'Meteorological Phenomenon':{ bg: 'bg-sky-100',    text: 'text-sky-800',    border: 'border-sky-300' },
  'Money':                    { bg: 'bg-yellow-100', text: 'text-yellow-900', border: 'border-yellow-400' },
  ...
  'Numerical Value':          { bg: 'bg-gray-100',   text: 'text-gray-700',   border: 'border-gray-300' },
  ...
  'Research':                 { bg: 'bg-cyan-100',   text: 'text-cyan-900',   border: 'border-cyan-400' },
  'Sensor':                   { bg: 'bg-red-100',    text: 'text-red-800',    border: 'border-red-300' },
  'Species':                  { bg: 'bg-blue-100',   text: 'text-blue-800',   border: 'border-blue-300' },
  'Technology':               { bg: 'bg-purple-100', text: 'text-purple-900', border: 'border-purple-400' },
  'Time':                     { bg: 'bg-orange-100', text: 'text-orange-800', border: 'border-orange-300' },
  'URL':                      { bg: 'bg-gray-100',   text: 'text-gray-600',   border: 'border-gray-300' },
}
